...
import org.unimag.controlador.Pasajero.PasajeroControladorGrabar;
...
public class VistaPasajeroCrear extends StackPane {
    ...
    private void crearFormulario() {
        Label lblNombre = new Label("Nombre del Pasajero");
        ...
        Label lblGenero = new Label("Género del Pasajero");
    ...
    private Boolean formularioCompleto() {
        ...
        if (txtEdadConductor.getText().isBlank()) {
            Mensaje.mostrar(Alert.AlertType.WARNING, this.getScene().getWindow(),
                    "Validación", "Por favor ingrese una edad para el Pasajero.");
    ...
    private void guardarGenero() {
        ...
        if (formularioCompleto()) {
            ...
            dto.setNombrePasajero(txtNombreConductor.getText());
            dto.setGeneroPasajero(obtenerSexo());
            dto.setEdadPasajero(Short.parseShort(txtEdadConductor.getText()));
