...
public class VistaPasajeroListar extends StackPane {
    ...
    private void crearTitulo() {
        ...
        Text titulo = new Text("LISTA PASAJEROS (" + cant + ")");
    ...
    private TableColumn<PasajeroDto, Integer> crearColumnaCedula() {
        TableColumn<PasajeroDto, Integer> columna = new TableColumn<>("Cédula");
        columna.setCellValueFactory(new PropertyValueFactory<>("cedulaPasajero"));
    ...
    private void crearTabla() {
        ...
        List<PasajeroDto> arrPasajero = PasajeroControladorListar.obtenerPasajero();
