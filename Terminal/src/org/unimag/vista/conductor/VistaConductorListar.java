...
public class VistaConductorListar extends StackPane {
    ...
    private void crearTitulo() {
        ...
        Text titulo = new Text("LISTA CONDUCTORES (" + cant + ")");
    ...
    private TableColumn<ConductorDto, Integer> crearColumnaCedula() {
        TableColumn<ConductorDto, Integer> columna = new TableColumn<>("Cédula");
    ...
    private void crearTabla() {
        ...
        List<ConductorDto> arrConductor = ConductorControladorListar.obtenerConductor();
