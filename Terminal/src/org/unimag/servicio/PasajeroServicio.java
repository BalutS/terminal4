...
public class PasajeroServicio implements ApiOperacionBD<PasajeroDto, Integer> {
    ...
    public PasajeroDto inserInto(PasajeroDto dto, String ruta) {
        ...
        objPasajero.setCedulaPasajero(getSerial());
        ...
        String filaGrabar = objPasajero.getCedulaPasajero() + Persistencia.SEPARADOR_COLUMNAS
        ...
        if (miArchivo.agregarRegistro(filaGrabar)) {
            dto.setCedulaPasajero(objPasajero.getCedulaPasajero());
            return dto;
        }
    ...
    public List<PasajeroDto> selectFrom() {
        ...
        for (String cadena : arregloDatos) {
            try {
                ...
                objPasajeroDto.setCedulaPasajero(Integer.parseInt(columnas[0].trim()));
