...
public class ConductorServicio implements ApiOperacionBD<ConductorDto, Integer> {
    ...
    public ConductorDto inserInto(ConductorDto dto, String ruta) {
        ...
        objConductor.setCedulaConductor(getSerial());
        ...
        String filaGrabar = objConductor.getCedulaConductor() + Persistencia.SEPARADOR_COLUMNAS
        ...
        if (miArchivo.agregarRegistro(filaGrabar)) {
            dto.setCedulaConductor(objConductor.getCedulaConductor());
            return dto;
        }
    ...
    for (String cadena : arregloDatos) {
        try {
            ...
            objConductorDto.setCedulaConductor(Integer.parseInt(columnas[0].trim()));
